	 ...
	 * @author S.K Jana Version 1.0 
	 ...
	 public class TimesheetImpl {
		...
		public  boolean   DogetPostDelete(String[] childtabs){
			...
			String sql=query.removeSql("Timesheet",this.getParentobjid(),childtabs);
		...
		public  boolean  DogetPostInsert(){
			...
			if(!tu.isEmptyValue(this.getMainxml())){
					sql=query.makeBulkSQL(true,this.getMainxml(),"Timesheet2Tasks",this.getUsername(),this.getGroupuser());
