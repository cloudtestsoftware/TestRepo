		...
		<div id="signinBlock">
			<span class="formContainer">
				<form id="passwordResetForm" onsubmit="return resetPassword();" action="/rest/email/resetpassword" method="POST">
					...
					<span class="signinRow field ">
						<input class="fillin" id="email" name="email" title="Email" type="email"  required="required" autocomplete="off" autofocus="autofocus" placeholder="Your Email Address" />
