	 ...
	 * @author S.K Jana Version 1.0 
	 ...
	 public class SubscriptionImpl {
		...
		public  boolean   DogetPostDelete(String[] childtabs){
			...
			String sql=query.removeSql("Subscription",this.getParentobjid(),childtabs);
		...
		public  boolean  DogetPostInsert(){
			...
			if(!tu.isEmptyValue(this.getMainxml())){
					sql=query.makeBulkSQL(true,this.getMainxml(),"Subscription2Company",this.getUsername(),this.getGroupuser());
