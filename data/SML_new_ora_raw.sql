...
Drop table Table_testuser;

Create Table Table_TestUser( 
 ObjId  	raw(16)  NULL,
...
CREATE UNIQUE INDEX Table_TestUSER_PK ON 
  Table_TestUSER(OBJID) ;

CREATE UNIQUE INDEX Table_TestUSER_U01 ON 
  Table_TestUSER(LOGINName);
...
CREATE TABLE SML_AttributeRelation (
	...
	DefaultFilter Varchar2 (4000) NULL ,
...
CREATE UNIQUE INDEX SML_ViewRelation_PK ON 
  ...
  */
  ...
  Drop Table SML_CustomQuery;
  
  CREATE TABLE SML_CUSTOMQUERY 
   (	OBJID raw(16) NOT NULL , 
	TABLENAME VARCHAR2(50 BYTE), 
	InputIds VARCHAR2(500 BYTE),
	FieldType VARCHAR2(100 BYTE),
	InputCaptions VARCHAR2(500 BYTE),
	SearchQuery VARCHAR2(4000 BYTE),
	GENUSER VARCHAR2(50 BYTE), 
	GENDATE DATE, 
	MODUSER VARCHAR2(50 BYTE), 
	MODDATE DATE
  ...
  CREATE UNIQUE INDEX SML_CUSTOMQUERY_PK ON SML_CUSTOMQUERY (OBJID); 
