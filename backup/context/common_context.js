...
function getAdditionalRelation(menu, table){
	try{
		if(menu && table){
			return menuconfig.menues[menu][table].relatedto; 
		}
	}catch(err){
		if(debug){
...
var menuconfig={
	    "menues": {
	        ...
	        "mytasks": {
	            "mytasks": {"caption":"My Tasks","button_width":"100","child":"tasknote","form":"tasks","formcolhide":"loginname","disablefields":"storypoint"},
	        ...
	        "mybug": {
	        	...
	        	"bugscenerio": {"caption":"Test Scenerio", "relation":"bugscenerio2bug", "parent":"mybug","button_width":"100"},
	        	"attachment": {"caption":"Attachments", "relation":"attachment2bug", "parent":"mybug","button_width":"100","buttonhide":"attachment_view_set"},
	            "resolution": {"caption":"Resolution", "relation":"resolution2bug", "parent":"mybug","button_width":"100","buttonhide":"resolution_view_set"}
		        
	        },
	        "mytraining": {
	            "mytraining": {"caption":"Training Schedule","button_width":"100","child":"bookcourse","formcolhide":"mytraining2training","showlistcols":[3,9]},
	            "bookcourse": {"caption":"Book Course", "relation":"bookcourse2training", "parent":"mytraining","button_width":"100","disablefields":"status,amountpaid,confirmationno","buttonhide":"create,prod","formload":"verify_prod_access","rowselect":"verify_prod_access","buttonhide":"coursefeedback_next_steps"},
	        },
	        "mycontact": {
	        ...
	        "cloudsetting": {
	            "cloudsetting": {"caption":"Cloud Setting","button_width":"100","child":"customerimage","showlistcols":[2,3]},
	            "customerimage": {"caption":"Customer Images", "relation":"customerimage2cloudsetting", "parent":"cloudsetting","button_width":"100","disablefields":"imageid,artifact,ostype,status,instanceid,adminuser,adminpassword,region","formchange":"set_customercloud_form_data"},
	        },
	        "bookcourse": {
	            "bookcourse": {"caption":"Book Course", "relation":"bookcourse2training", "parent":"mytraining","child":"coursefeedback","button_width":"100","disablefields":"status,amountpaid,confirmationno","buttonhide":"create,prod","formload":"verify_prod_access","rowselect":"verify_prod_access","buttonhide":"coursefeedback_priv_steps"},
	        ...
	        "training": {
	            ...
	            "bookcourse": {"caption":"Book Course", "relation":"bookcourse2training", "parent":"training","child":"coursefeedback","button_width":"100"},
	            "coursefeedback": {"caption":"Feedback", "relation":"coursefeedback2bookcourse", "parent":"bookcourse","button_width":"100"},
	        },
	        "support": {
	        ...
	        "product": {
	            ...
	            "project": {"caption":"Projects", "relatedto":"project2product:release2product", "relation":"project2release","parent":"release","button_width":"100","buttonhide":"project_next_step"},
	            ...
	            "documents": {"caption":"Documents", "relation":"documents2release", "parent":"release","button_width":"100"},
	        ...
	        "project": {
	        	"project": {"caption":"Projects", "relation":"project2product","child":"epic","parent":"product","button_width":"100","uri":"rows","buttonhide":"create,project_priv_step"},
	        	 "epic": {"caption":"Epic", "relation":"epic2project", "parent":"project","child":"feature","button_width":"100"},
	        	"feature": {"caption":"Features",  "relatedto":"feature2project:epic2project","relation":"feature2epic", "child":"scenerio", "parent":"project","button_width":"100","formload":"update_feature_status","rowselect":"update_feature_status","buttonhide":"scroll:mytasks"},
	            "scenerio": {"caption":"Scenarios", "relation":"scenerio2feature", "child":"matrixlist", "parent":"feature","button_width":"100","formcolhide":"projectname,featurename,externid"},
	            ...
	            "documents": {"caption":"Documents", "relation":"documents2epic", "parent":"epic","button_width":"100"},
	        ...
	        "feature": {
	        	"feature": {"caption":"Features", "relation":"feature2project", "child":"scenerio", "parent":"project","button_width":"100","uri":"rows","formload":"update_feature_status","rowselect":"update_feature_status","buttonhide":"feature_priv_step,scroll:mytasks"},
	        	"scenerio": {"caption":"Scenarios", "relation":"scenerio2feature", "child":"matrixlist", "parent":"feature","button_width":"100","formcolhide":"projectname,featurename,externid"},
	        	"jenkinsjob": {"caption":"Jenkins Job", "relation":"jenkinsjob2feature", "parent":"feature","button_width":"100"},
	        	"documents": {"caption":"Documents", "relation":"documents2feature", "parent":"feature","button_width":"100"},
	        	"teststeps": {"caption":"Tests", "relation":"teststeps2scenerio", "parent":"scenerio","button_width":"100","formcolhide":"externid"},
	        	"tasks": {"caption":"Tasks", "relation":"tasks2feature", "parent":"feature","button_width":"100","buttonhide":"tasks_next_step"},
	            "matrixlist": {"caption":"Matrix", "relation":"matrixmap2scenerio", "parent":"scenerio","button_width":"100","rowselect":"update_matrixlist_for_scenerio","excludecolupdate":":scenerio","buttonhide":"scroll:project"},
	        	"featuretestcount": {"caption":"Feature Facts", "relation":"featuretestcount2feature","parent":"feature","button_width":"100","showlistcols":[3,5],"rowselect":"draw_testcount_chart","formload":"draw_testcount_chart","chartcols":[5,6,7,8]},
	        ...
	        "testrun": {
	        	"testrun": {"caption":"Matrix Run","child":"featurerun","button_width":"100","showlistcols":[5,6],"formcolhide":"productname","uri":"rows","buttonhide":"create,testrun_priv_step"},
	        	"featurerun": {"caption":"Feature Run", "relation":"featurerun2testrun", "child":"testscenerio", "parent":"testrun","button_width":"100"},
	        	...
	        	"testscenerio": {"caption":"Test Scenario", "relation":"testscenerio2featurerun", "child":"sceneriorun", "parent":"featurerun","button_width":"100","rowselect":"create_new_sceneriorun_form"},
	        	"sceneriorun": {"caption":"Test Run", "relation":"sceneriorun2testscenerio","relatedto":"sceneriorun2testrun","child":"attachment", "parent":"testscenerio","button_width":"100","uri":"rows","formcolhide":"envname"},
	        	"bug": {"caption":"Defect", "relation":"bug2sceneriorun", "parent":"sceneriorun","button_width":"100"},
	        	"teststeps": {"caption":"Test Steps", "relatedto":"teststeps2scenerio", "parent":"testscenerio","button_width":"100","buttonhide":"create,save","formcolhide":"externid"},
	        	"attachment": {"caption":"Attachments", "relation":"attachment2sceneriorun", "parent":"sceneriorun","button_width":"100"},
		        "testrunresult": {"caption":"Matrix Run Facts", "relation":"testrunresult2testrun","parent":"testrun","button_width":"100","rowselect":"draw_board_chart","formload":"draw_board_chart","chartcols":[4,5,6,7,11]},
	        ...
	        "featurerun": {
	        	"featurerun": {"caption":"Feature Run", "relation":"featurerun2testrun", "child":"testscenerio", "parent":"testrun","button_width":"100","uri":"rows","buttonhide":"featurerun_priv_step"},
	        	"testscenerio": {"caption":"Test Scenerio", "relation":"testscenerio2featurerun", "child":"sceneriorun", "parent":"featurerun","button_width":"100","rowselect":"create_new_sceneriorun_form"},
		        "sceneriorun": {"caption":"Scenario Run", "relation":"sceneriorun2testscenerio","relatedto":"sceneriorun2testrun","child":"attachment", "parent":"testscenerio","button_width":"100","uri":"rows","formcolhide":"envname"},
	        	"attachment": {"caption":"Attachments", "relation":"attachment2sceneriorun", "parent":"sceneriorun","button_width":"100"},
	        	"bug": {"caption":"Defect", "relation":"bug2sceneriorun", "parent":"sceneriorun","button_width":"100"},
	        	"teststeps": {"caption":"Test Steps", "relatedto":"teststeps2scenerio", "parent":"testscenerio","button_width":"100","buttonhide":"create,save","formcolhide":"externid"},
	        	"featuretestresult": {"caption":"Feature Run Facts", "relation":"featuretestresult2featurerun","relatedto":"featurerun2testrun","parent":"featurerun","button_width":"100","buttonhide":"scroll:feature:tabwidget","rowselect":"draw_board_chart","formload":"draw_board_chart","chartcols":[4,5,6,7,11]},
	        ...
	        "testscenerio": {
	        	 "testscenerio": {"caption":"Test Scenerio", "relation":"testscenerio2featurerun", "child":"sceneriorun", "parent":"featurerun","button_width":"100","rowselect":"create_new_sceneriorun_form","buttonhide":"testscenerio_priv_step"},
	        	 "sceneriorun": {"caption":"Scenario Run", "relation":"sceneriorun2testscenerio","relatedto":"sceneriorun2testrun","child":"attachment", "parent":"testscenerio","button_width":"100","uri":"rows","formcolhide":"envname","buttonhide":"scroll:featurerun"},
		          "attachment": {"caption":"Attachments", "relation":"attachment2sceneriorun", "parent":"sceneriorun","button_width":"100","buttonhide":"scroll:featurerun"},
	        	  "bug": {"caption":"Defect", "relation":"bug2sceneriorun", "parent":"sceneriorun","button_width":"100"},
	        	  "teststeps": {"caption":"Test Steps", "relatedto":"teststeps2scenerio", "parent":"testscenerio","button_width":"100","buttonhide":"create,save","formcolhide":"externid"},
	        ...
	        "testmatrix": {
	        	...
	        	"testrun": {"caption":"Matrix Run", "relatedto":"testrun2product:testmatrix2product", "relation":"testrun2testmatrix","parent":"testmatrix","button_width":"100","formcolhide":"productname","buttonhide":"testrun_next_step"},
	        ...
	        "bug": {
	        	...
	        	"bugscenerio": {"caption":"Test Scenario", "relation":"bugscenerio2bug", "parent":"bug","button_width":"100"},
	        	"attachment": {"caption":"Attachments", "relation":"attachment2bug", "parent":"bug","button_width":"100","buttonhide":"attachment_view_set"},
	            "resolution": {"caption":"Resolution", "relation":"resolution2bug", "parent":"bug","button_width":"100"}
	        ...
	        "projectboard": {
	            ...
	            "feature": {"caption":"Feature", "relation":"feature2board", "parent":"board","child":"tasks","button_width":"100","formcolhide":"projectname"},
	            ...
	            "burndownchart": {"caption":"Burndown Chart", "relation":"burndownchart2project","parent":"projectboard","button_width":"100","rowselect":"draw_burndown_chart","formload":"draw_burndown_chart","chartcols":[5,6]},
	            ...
	            "featuretestresult": {"caption":"Feature Run Facts", "relation":"featuretestresult2featurerun","parent":"feature","button_width":"100","buttonhide":"featurerun:featuretestresult:removeMe","rowselect":"draw_board_chart","formload":"draw_board_chart","chartcols":[4,5,6,7,11]},
...
function draw_sprintvelocity_chart(table) {
	...
	widget_form.attachEvent("onChange", function (name, value){
		...
		doMultiBarChart(chartcontainer,data, xlabel,ylabel,table,colmxId);
...
var myBarChart;
function doMultiBarChart(chartcontainer,data, xlabel,ylabel,table,colmxId) {
	 var grid=gridlist[table];
	 var ymax=10;
	 var value=0;
	 if(grid){
	...
	myBarChart =  new dhtmlXChart({
		...
		legend:{
			values:[{text:"Sprint",color:"#58dccd"},{text:"Devlopment",color:"#a7ee70"},{text:"Testing",color:"#36abee"}],
			valign:"middle",
			align:"right",
			width:100,
			layout:"y"
