	 ...
	 * @author S.K Jana Version 1.0 
	 ...
	 public class ObjectruleImpl {
		...
		public  boolean   DogetPostDelete(String[] childtabs){
			...
			String sql=query.removeSql("Objectrule",this.getParentobjid(),childtabs);
		...
		public  boolean  DogetPostInsert(){
			...
			if(ACONST.GENERATE_LOG)
			 ...
			 if (query.getTableResultset().getRowCount()>0){
				 ...
				 String ActionQueryrelation="ActionQuery2Objectrule";
				 usql+="\n\t\t"+tu.copyParent2Child(maindata,"ActionQuery",autofieldActionQuerylist,ActionQueryrelation,getParentobjid());
				 usql=(usql.equals("")?"":"\n\t begin"+usql +"\n\t end;");
				 if(!usql.equals(""))
