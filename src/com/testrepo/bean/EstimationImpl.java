	 ...
	 * @author S.K Jana Version 1.0 
	 ...
	 public class EstimationImpl {
		 ...
		 public String EstimationFilter="epiccost.epichrs totalhr,epiccost.epiccost totalcost@estimation,epiccost@estimation.estimation2epic=epiccost.epiccost2epic";
		...
		public  boolean   DogetPostDelete(String[] childtabs){
			...
			String sql=query.removeSql("Estimation",this.getParentobjid(),childtabs);
