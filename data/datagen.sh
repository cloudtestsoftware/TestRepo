...
#java -classpath $JAVA_CLASSPATH cms.service.gen.datagen -import schema -file $DATA_PATH/testrepo_service.dat -table SubCode  -log cms.log -inifile $DATA_PATH/context.xml
