	...
	public class ModuleDao extends ModuleImpl {
		...
		private String []deletetabs={"module,"};
		private String []childtabs={""};
		private String []childtabnames={""};
		
		private String [] maincol={"objid","module2privilegegroup","name"};
		private String [] maincolcaption={"Id","PrivilegeGroup","Module Name"};
		private String [] mainsqldatatype={DataType.VARCHAR,DataType.INTEGER,DataType.VARCHAR};
		private String [] mainformfields={"input","input","combo"};
		private String [] maindatadomain={"Int_t","Int_t","Name_t"};
		private String [] maincolsearch={"#text_filter,#select_filter,#select_filter"};
		...
		private String [] reportcolcaption={"Id","Module Name"};
		...
		private String [] searchcolcaption={"Id","Module Name"};
		private String [] searchcoltype={"integer","select"};
		private String [] searchdatadomain={"Id_t","Name_t"};

		private String [] propModulelist={"name"};
		private String [] codeModulelist={};
		private String [] relationModulelist={"privilegegroup:module2privilegegroup:list:"};
		...
		public Rows getModuleSummaryRows(){
			TemplateTable tab=this.DogetPostSelect(summarycol,summarysqldatatype,this.ModuleFilter,false);
		...
		public Rows getModuleRows(){
			TemplateTable tab=this.DogetPostSelect(maincol,mainsqldatatype,this.ModuleFilter,false);
			Rows rows=tu.getXMLRows(tab, "Module",codeModulelist,propModulelist,relationModulelist,maincolcaption,maindatadomain,this.getGroupuser());
			return rows;
		}

		public Items getModuleForm(){
			TemplateTable tab=this.DogetPostSelect(maincol,mainsqldatatype,this.ModuleFilter,true);
			Items items=tu.getXMLForm(tab, "Module",codeModulelist,propModulelist,relationModulelist,maincolcaption,maindatadomain,mainformfields,this.getGroupuser(),this.getRelationFilters());
			return items;
		}

		public Rows getModuleRowModified(){
			Rows rows=tu.getXMLRows(maindata, "Module",codeModulelist,propModulelist,relationModulelist,maincolcaption,maindatadomain,this.getGroupuser());
			return rows;
		}
		public Rows getModuleRowUpdated(){
			Rows rows;
			String sql= "update table_Module set "+this.getData() + " where objid='"+this.getParentobjid()+"' and groupuser='"+this.getGroupuser()+"'";
		...
		public Rows getModuleByFilter(){
			...
			TemplateTable tab=tu.getResultSet(sql);
			Rows rows=tu.getXMLFilterRows(tab, "Module",codeModulelist,propModulelist,relationModulelist,maincol,maincolcaption,maindatadomain,this.getGroupuser());
			return rows;
		}
	}
