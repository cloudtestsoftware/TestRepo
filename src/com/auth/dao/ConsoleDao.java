...
import com.auth.bean.ConsoleImpl;
...
import cms.service.template.TemplateTable; 
	...
	public class ConsoleDao extends ConsoleImpl {
		...
		private String [] maincol={"objid","console2messagequeue","name","title","description","status","keyobjid","elapseday","entrydate"};
		...
		private String [] relationConsolelist={"console2messagequeue"};
		...
		public Rows getConsoleSummaryRows(){
			TemplateTable tab=this.DogetPostSelect(summarycol,summarysqldatatype,this.ConsoleFilter);
		...
		public Rows getConsoleRowModified(){
			Rows rows=tu.getXMLRows(maindata, "Console",codeConsolelist,propConsolelist,relationConsolelist,maincolcaption,maindatadomain,this.getGroupuser());
			return rows;
		}
		...
		public Rows getConsoleByFilter(){
			...
			Rows rows=tu.getXMLFilterRows(tab, "Console",codeConsolelist,propConsolelist,relationConsolelist,maincol,maincolcaption,maindatadomain,this.getGroupuser());
			ArrayList<Userdata> userdata=rows.getUserdata();
