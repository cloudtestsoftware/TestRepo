	 ...
	 * @author S.K Jana Version 1.0 
	 ...
	 public class CompanyImpl {
		...
		public  boolean   DogetPostDelete(String[] childtabs){
			...
			String sql=query.removeSql("Company",this.getParentobjid(),childtabs);
		...
		public  boolean  DogetPostInsert(){
			...
			if(sql==null){
				...
				setParentobjid(query.getObjId()); 
				 if(!tu.isEmptyValue(this.getTestuserxml()) ){
					 sql+=query.makeBulkSQL(false,getTestuserxml(),"TestUser2Company",this.getUsername(),this.getGroupuser());
				 ...
				 if(!tu.isEmptyValue(this.getSubscriptionxml()) ){
					 sql+=query.makeBulkSQL(false,getSubscriptionxml(),"Subscription2Company",this.getUsername(),this.getGroupuser());
			...
			if(ACONST.GENERATE_LOG)
			 ...
			 if (query.getTableResultset().getRowCount()>0){
				 ...
				 tu.applyMTMRelation("testuser","Company",getParentobjid());
				 ...
				 tu.applyMTMRelation("subscription","Company",getParentobjid());
